...
class ImgGen extends Img {
	...
	public c(r: number, g = -1, b = -1, a = -1): this {
	...
	public bg(): this { this.texture?.background(); return this }
	public rect(x: number, y: number, w: number, h: number): this { this.texture?.rect(x, y, w, h); return this }
	...
	public noise(detail: number, threshold = 0, size = 16): this {
		threshold /= 255
		let d = 0
